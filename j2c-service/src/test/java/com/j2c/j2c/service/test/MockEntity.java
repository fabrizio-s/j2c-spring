...
import static com.j2c.j2c.service.test.MockRepositoryUtils.*;
import static com.j2c.j2c.service.test.TestUtils.randomLong;
import static com.j2c.j2c.service.test.TestUtils.spyField;
...
public final class MockEntity {
    ...
    private static Role mRole(
        ...
        setFieldIfNotNull(role, "type", type);
    ...
    @Builder(builderClassName = "MockUserVerificationTokenBuilder",
            builderMethodName = "userVerificationToken")
    private static UserVerificationToken mUserVerificationToken(
            final UUID id,
            final User user
    ) {
        final UserVerificationToken verificationToken = newEntity(UserVerificationToken.class, id);

        setUnidirectionalRelation(verificationToken, "user", user);
    ...
    private static ProductCategory mProductCategory(
            ...
            final String description,
            final String imageFilename,
            final boolean nullRootCategory
    ) {
