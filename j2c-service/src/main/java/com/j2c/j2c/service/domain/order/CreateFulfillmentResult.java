...
public final class CreateFulfillmentResult {
    ...
    @NonNull
    private final OrderFulfillment createdFulfillment;

    @NonNull
    private final List<OrderFulfillmentLine> createdFulfillmentLines;
